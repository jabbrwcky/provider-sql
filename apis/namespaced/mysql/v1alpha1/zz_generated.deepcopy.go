...
func (in *AuthenticationPlugin) DeepCopyInto(out *AuthenticationPlugin) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AuthenticationPlugin.
func (in *AuthenticationPlugin) DeepCopy() *AuthenticationPlugin {
	if in == nil {
		return nil
	}
	out := new(AuthenticationPlugin)
	in.DeepCopyInto(out)
	return out
}
