...
// Because Connect gates every operation, a connection proxy that does not
// expose server_version_num (a pgbouncer admin target, for instance) can no
// longer Observe, Create *or Delete* a Grant — the finalizer wedges and the
