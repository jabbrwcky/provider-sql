...
func (c *connector) Connect(ctx context.Context, mg *v1alpha1.User) (managed.TypedExternalClient[*v1alpha1.User], error) {
	...
	return &external{
		db:   c.newDB(secretData, tlsName, mg.Spec.ForProvider.BinLog, poolCfg, pc.Spec.SessionVariables),
		kube: c.kube,
	}, nil
}
...
func (c *external) updateResourceOptions(ctx context.Context, mg *v1alpha1.User, username, host string) error {
	ro := resourceOptionsToClauses(mg.Spec.ForProvider.ResourceOptions)
